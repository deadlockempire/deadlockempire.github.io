var levels = {
	...
	"L1-lock": new Level(
		...
		"<i>Locks</i> (or <i>mutexes</i>, from <i>mut</i>ual <i>ex</i>clusion) disallow more threads from running some code at the same time. At any point in time, a lock is either <i>locked</i> (or <i>held</i>) by one thread, or it's <i>unlocked</i>. Locks have two basic operations: <i>locking</i> and <i>unlocking</i>.<br>" +
