var levels = {
    ...
    "L1-lock": new Level(
        ...
        "Since C# 13 there is a designated type for locks (<a href='https://learn.microsoft.com/en-us/dotnet/api/system.threading.lock'>System.Threading.Lock</a>), but even before that all <code>object</code>s (including any classes) can act as locks and can be locked and unlocked via the <a href='https://msdn.microsoft.com/en-us/library/system.threading.monitor.aspx'>System.Threading.Monitor</a> static class.<br><br>" +
